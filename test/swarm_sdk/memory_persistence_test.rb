...
module SwarmSDK
  class MemoryPersistenceTest < Minitest::Test
    def setup
    ...
    def test_scratchpad_persists_on_write
      scratchpad = Tools::Stores::MemoryStorage.new(persist_to: @persist_path)
    ...
    def test_scratchpad_loads_from_existing_file
      ...
      scratchpad1 = Tools::Stores::MemoryStorage.new(persist_to: @persist_path)
      ...
      scratchpad2 = Tools::Stores::MemoryStorage.new(persist_to: @persist_path)
    ...
    def test_scratchpad_preserves_metadata
      ...
      assert_operator(entry[:updated_at], :>=, before_time)
      assert_operator(entry[:updated_at], :<=, after_time)
    end
    ...
    def test_scratchpad_handles_corrupted_file
      ...
      assert_match(/Warning.*Failed to load memory storage/, err)
    ...
    def test_scratchpad_creates_directory_if_needed
      ...
      scratchpad = Tools::Stores::MemoryStorage.new(persist_to: deep_path)
    ...
    def test_scratchpad_storage_without_persistence_does_not_create_file
      # ScratchpadStorage is volatile (never persists)
      scratchpad = Tools::Stores::ScratchpadStorage.new

      scratchpad.write(file_path: "test", content: "Test", title: "Test")

      # Should not create any persistence file
