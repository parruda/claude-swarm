...
module SwarmSDK
  class MarkdownParserTest < Minitest::Test
    def test_parse_valid_markdown_with_name_in_frontmatter
      ...
      assert_equal([:Read, :Edit], agent_def.tools)
    end
    ...
    def test_parse_strips_prompt_whitespace
      ...
      assert_equal("Test prompt with leading newlines.", agent_def.system_prompt)
    ...
    def test_parse_empty_prompt_creates_empty_system_prompt
      content = <<~MARKDOWN
        ---
        name: test
        description: Test
    ...
    def test_class_method_parse
      ...
      assert_instance_of(AgentDefinition, agent_def)
